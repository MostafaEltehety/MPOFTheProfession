...
namespace ManagingThePracticeOFTheProfession.PL.Forms
{
    public partial class Frm_PrintForm : Form
    {
        ...
        private void dataGridView1_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            string GotoIssued = string.Empty;
            ...
            if (lbl_IDForm.Text == "2") // SH_D
            {
                ...
                if (dataGridView1.CurrentCell.ColumnIndex.Equals(39))
                {
                  ...
                  // 5-5-2024
                    if (Check_IssuedFrom.Checked)
                        GotoIssued = cmb_GOTO.Text + " " + dt.Rows[0]["IssuedFrom"].ToString();
                    else
                        GotoIssued = cmb_GOTO.Text;
                    if (cmb_GOTO.Text == "أخرى")
                        GotoIssued=txt_other.Text;
                    ...
                    crpt.SetParameterValue("goto", GotoIssued);
            ...
            if (lbl_IDForm.Text == "5") // SH_W
            {
                ...
                if (dataGridView1.CurrentCell.ColumnIndex.Equals(50))
                {
